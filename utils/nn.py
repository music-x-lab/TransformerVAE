...
class NetworkEnsemble():
    ...
    def __init__(self,net_class,net_names,idx_start,idx_end,*args,load_checkpoint=True,**kwargs):
        self.net_class=net_class
        self.models=[NetworkInterface(net_class(*args,**kwargs),net_names%idx,load_checkpoint=load_checkpoint) for idx in range(idx_start,idx_end)]
